...
df_win %>%
  ggplot(aes(sh_per)) +
  geom_histogram(aes(y = ..density..), binwidth = 2, colour = "black", fill = "grey") +
...
df_win %>%
  ggplot(aes(hdsh_per)) +
  geom_histogram(aes(y = ..density..), binwidth = 4, colour = "black", fill = "grey") +
  geom_density(fill = "blue", alpha = 0.3) +
  geom_vline(aes(xintercept = mean(hdsh_per, na.rm = T)),
             colour = "red", linetype ="longdash", size = .8) +
  scale_x_continuous(breaks = seq(0, 80, 10), labels = function(x){paste0(x, "%")}, limits = c(-5, 80)) +
...
df_win %>%
  ...
  labs(x = "Shot Attempts Per 60 Minutes", y = "Density" , title = "Shot Attempts Per 60 Minutes in a Team Win") +
  theme_classic()
...
df_lose %>%
  ...
  geom_vline(aes(xintercept = mean(sf_per_60, na.rm = T)),
             colour = "blue", linetype ="longdash", size = .8) +
  scale_x_continuous(breaks = seq(0, 70, 10)) +
  labs(x = "Shot Attempts Per 60 Minutes", y = "Density" , title = "Shot Attempts Per 60 Minutes in a Team Loss") +
  theme_classic()
...
df_win %>%
  ...
  labs(x = "High Danger Shot Attempts Per 60 Minutes", y = "Density" , title = "High Danger Shot Attempts Per 60 in a Team Win") +
  theme_classic()
...
df_lose %>%
  ...
  geom_vline(aes(xintercept = mean(hdsf_per_60, na.rm = T)),
             colour = "blue", linetype ="longdash", size = .8) +
  scale_x_continuous(breaks = seq(0, 24, 3)) +
  labs(x = "High Danger Shot Attempts Per 60 Minutes", y = "Density" , title = "High Danger Shot Attempts Per 60 in a Team Loss") +
  theme_classic()
